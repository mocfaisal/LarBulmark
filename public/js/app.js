...
/* harmony import */ var _inertiajs_vue2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @inertiajs/vue2 */ "./node_modules/@inertiajs/vue2/dist/index.esm.js");
...
(0,_inertiajs_vue2__WEBPACK_IMPORTED_MODULE_0__.createInertiaApp)({
  ...
  setup: function setup(_ref) {
    var el = _ref.el,
      ...
      props = _ref.props,
      plugin = _ref.plugin;
    vue__WEBPACK_IMPORTED_MODULE_4__["default"].use(plugin).use(buefy__WEBPACK_IMPORTED_MODULE_5__["default"]).use(ziggy__WEBPACK_IMPORTED_MODULE_2__.ZiggyVue, _ziggy__WEBPACK_IMPORTED_MODULE_3__.Ziggy).component("Link", _inertiajs_vue2__WEBPACK_IMPORTED_MODULE_0__.Link).component("Head", _inertiajs_vue2__WEBPACK_IMPORTED_MODULE_0__.Head).mixin({
      methods: {
        route: route
      }
    });
...
!function (t, r) {
  ...
  var a = String.prototype.replace,
    ...
    x = function t(r, e, n, o, i, u, f, a, c, l, s, v, p, y) {
      var d,
        h = r;
      ...
      for (var C = 0; C < x.length; ++C) {
        ...
        if (!i || null !== D) {
          ...
          O(T, t(D, F, n, o, i, u, f, a, c, l, s, v, p, y));
        }
      }
      return T;
    },
      ...
      for (var n = "string" == typeof t ? function (t, r) {
          ...
          for (e = 0; e < o.length; ++e) if (e !== i) {
            var f,
              ...
              l = c.indexOf("]="),
              s = -1 === l ? c.indexOf("=") : l + 1;
            -1 === s ? (f = r.decoder(c, C.decoder, u, "key"), a = r.strictNullHandling ? null : "") : (f = r.decoder(c.slice(0, s), C.decoder, u, "key"), a = b.maybeMap(D(c.slice(s + 1), r), function (t) {
              return r.decoder(t, C.decoder, u, "value");
            })), a && r.interpretNumericEntities && "iso-8859-1" === u && (a = N(a)), c.indexOf("[]=") > -1 && (a = k(a) ? [a] : a), n[f] = T.call(n, f) ? b.combine(n[f], a) : a;
          }
          return n;
      ...
      return f.toString = function () {
        ...
        return this.i.compile(this.u) + function (t, r) {
          ...
          for (var f = 0; f < e.length; ++f) {
            var a = e[f];
            o.skipNulls && null === n[a] || O(i, x(n[a], a, u, o.strictNullHandling, o.skipNulls, o.encode ? o.encoder : null, o.filter, o.sort, o.allowDots, o.serializeDate, o.format, o.formatter, o.encodeValuesOnly, o.charset));
          }
...
var render = function () {
  ...
  return _c(
    ...
    [
      _c("Head", [
        _c("title", [
          _vm._v(_vm._s(_vm.$page.props.title) + " - My awesome app"),
        ]),
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "box" }, [
        _c("div", { staticClass: "p-6" }, [
          _c(
            "div",
            { staticClass: "flex space-x-4 mb-4" },
            [
              _c(
                "Link",
                {
                  staticClass:
                    "text-gray-700 bg-gray-200 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium",
                  attrs: { href: _vm.route("homepage") },
                },
                [_vm._v("\n                Homepage")]
              ),
              _vm._v(" "),
          ...
          _vm._v(" "),
          _c("h1", [
            _vm._v("This is: " + _vm._s(_vm.$page.props.title) + " 1"),
          ]),
        ]),
      ]),
    ],
    ...
    [
      ...
      _c("div", { staticClass: "box" }, [
        _c("div", { staticClass: "p-6" }, [
          ...
          _vm._v(" "),
          _c("h1", [
            _vm._v("This is: " + _vm._s(_vm.$page.props.title) + " 2"),
          ]),
        ]),
      ]),
    ],
    ...
    [
      ...
      _c("div", { staticClass: "box" }, [
        _c("div", { staticClass: "p-6" }, [
          ...
          _vm._v(" "),
          _c("h1", [
            _vm._v("This is: " + _vm._s(_vm.$page.props.title) + " 3"),
          ]),
        ]),
      ]),
    ],
